...
const Component: FunctionComponent<ICommentForm.IProps> = ({
    ...
    const leaveComment = useSelector(
        (state: IStore) => state.Store.leaveComment
    );
    const storeId = useSelector((state: IStore) => state.Store.store.id);
    const slug = useSelector((state: IStore) => state.Store.store.slug);
    const pagination = useSelector(
        (state: IStore) => state.Store.comments.pagination
    );
    const activeCommentId = useSelector(
        (state: IStore) => state.Store.activeCommentId
    );
