...
export const Block = () => (
    <Text block marginX={2}>
        Sometimes a block needs to stand on its own block, especially when it
        needs margins
    </Text>
);
...
export const Variants = () => (
    <>
        <Text variant="body" block marginBottom={4}>
            body is the default variant which inherits color from it&apos;s
            container
        </Text>
        ...
        <Text variant="danger">
            Now, we really want your atttention, hello!
        </Text>
    </>
);
...
export const Weight = () => (
    <>
        <Text weight="thin">
            thin: These are all the weights Inter supports
        </Text>
        <br />
        <Text weight="light">
