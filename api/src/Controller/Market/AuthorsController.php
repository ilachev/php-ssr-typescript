...
use App\Model\Market\UseCase\Author\Archive;
use App\Model\Market\UseCase\Author\Create;
use App\Model\Market\UseCase\Author\Edit;
use App\Model\Market\UseCase\Author\Reinstate;
use App\Model\User\Entity\User\User;
use App\ReadModel\Market\Author\AuthorFetcher;
use App\ReadModel\Market\Author\Filter;
...
/**
 * @IsGranted("ROLE_MARKET_MANAGE_AUTHORS")
 */
#[Route('/market/authors', name: 'market.authors')]
class AuthorsController extends AbstractController
{
    ...
    {
        $this->denyAccessUnlessGranted('ROLE_MARKET_MANAGE_AUTHORS');
        ...
        return $this->render('app/market/authors/index.html.twig', [
    ...
    public function create(User $user, Request $request, AuthorFetcher $authors, Create\Handler $handler): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            try {
                ...
                return $this->redirectToRoute('market.authors.show', ['id' => $user->getId()]);
        ...
        return $this->render('app/market/authors/create.html.twig', [
            'form' => $form->createView(),
        ]);
    }
    ...
    public function edit(Author $author, Request $request, Edit\Handler $handler): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            try {
                ...
                return $this->redirectToRoute('market.authors.show', ['id' => $author->getId()]);
            } catch (\DomainException $e) {
                $this->errors->handle($e);
                $this->addFlash('error', $e->getMessage());
            }
        ...
        return $this->render('app/market/authors/edit.html.twig', [
            'author' => $author,
            'form' => $form->createView(),
        ]);
    }
    ...
    public function show(Author $author): Response
    {
        ...
        return $this->render('app/market/authors/show.html.twig', compact('author'));
    }
}
